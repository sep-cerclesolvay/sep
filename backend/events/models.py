...
class Ticket(models.Model):
    ...
    qrcode_id = models.CharField(
        _('QR code identifier'), max_length=8, validators=[RegexValidator(r'[A-Z0-9]{12}}', message=_('The QR code identifier must contain exactly 12 characters in the A-Z,0-9 range'))])
